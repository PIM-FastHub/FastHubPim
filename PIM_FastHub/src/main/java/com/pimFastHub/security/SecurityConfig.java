...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .antMatchers(HttpMethod.GET, "/prestador/**").hasRole("PRESTADOR")
                .antMatchers(HttpMethod.POST, "/prestador/**").hasRole("PRESTADOR")
                .antMatchers(HttpMethod.GET, "/cliente/**").hasRole("CLIENTE")
                .antMatchers(HttpMethod.POST, "/cliente/**").hasRole("CLIENTECLIENTE")
